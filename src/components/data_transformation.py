...
class DataTransformationConfig:
    ...
    Stores the path to save the preprocessing object.
    """
...
class DataTransformation:
    """
    Class to handle feature engineering and data preprocessing.
    Creates pipelines for numerical and categorical features,
    applies them on train and test datasets, and saves the preprocessing object.
    """
    ...
    def initiate_data_transformation(self, train_path: str, test_path: str):
        ...
        Returns transformed train/test arrays and path to preprocessor.
        """
        try:
            # Read datasets
